...
/* TODO: 替换为自己设备的三元组 */
static char *product_key       = "a16bTikWROS";
static char *device_name       = "n001";
static char *device_secret     = "f3640db1414c5883b7996ebdfb0eb958";
...
*/
static char  *mqtt_host = "iot-06z00b0c4a5stcb.mqtt.iothub.aliyuncs.com";
...
void cm_test_aliyun(void)
{
    ...
    */
    ...
    while (count--) {
        ...
        char *pub_topic = "/a16bTikWROS/n001/user/cmdSend";
    ...
    // if (res < STATE_SUCCESS) {
    //     aiot_mqtt_deinit(&mqtt_handle);
    //     DBG_I("aiot_mqtt_disconnect failed: -0x%04X\n", -res);
    //     return;
    // }
    ...
    // if (res < STATE_SUCCESS) {
    //     DBG_I("aiot_mqtt_deinit failed: -0x%04X\n", -res);
    //     return;
    // }
