...
void bdr_motor_init(void)
{
    ...
    my_io_init_2(MOTOR_IN0_GPIO_NUM, MOTOR_IN0_GPIO_PIN, cfg, CM_IOMUX_FUNC_FUNCTION2);
    my_io_init_2(MOTOR_IN1_GPIO_NUM, MOTOR_IN1_GPIO_PIN, cfg, CM_IOMUX_FUNC_FUNCTION2);
    my_io_init_2(MOTOR_IN2_GPIO_NUM, MOTOR_IN2_GPIO_PIN, cfg, CM_IOMUX_FUNC_FUNCTION2);
}
...
void bdr_hall_init(void)
{
    ...
    my_io_init_2(HALL_EN_GPIO_NUM, HALL_EN_GPIO_PIN, cfg, CM_IOMUX_FUNC_FUNCTION2);
}
